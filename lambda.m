...
% When Lambda=[0.7,1.2,1.7,2.2],reverse solution of Laplace space bottomhole pressure (equation (62)) to real space bottomhole pressure (equation (63)) 
for k=1:4
    for i=1:L
        ft(i,k)=0;
        u=log(2)/tD(i);
...
% Three point method for derivative calculation (pressure derivative in thesense of well testing analysis),when Lambda=[0.7,1.2,1.7,2.2]
for k=1:4
...
% Double logarithmic curves of bottomhole pressure at different Lambda
...
% Double logarithmic curves of bottomhole pressure derivatives at different Lambda
