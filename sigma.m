...
% When sigma=[0.1,1.1,2.1,3.1],reverse solution of Laplace space bottomhole pressure (equation (62)) to real space bottomhole pressure (equation (63)) 
for k=1:4
    for i=1:L
        ft(i,k)=0;
        u=log(2)/tD(i);
        for j=1:M
           ...
           % Code for guide function: equation (24) 
            E=((r1*RD)^(1-(df2-Theta2)/2))*posimn(v2,v2,r1^(1+Theta2/2),RD^(1+Theta2/2),(2/(Theta2+2))*sqrt(sigma(k)*z/CDE2S));
           
             % Code for guide function: equation (25) 
            F=(r1^(1-(df2-Theta2)/2))*(RD^(-(df2-Theta2)/2))*((2+Theta2-df2)*posimn(v2,v2,r1^(1+Theta2/2),RD^(1+Theta2/2),(2/(Theta2+2))*sqrt(sigma(k)*z/CDE2S))+sqrt(sigma(k)*z/CDE2S)...
                *(RD^(1+Theta2/2))*posimn(v2,v2+1,r1^(1+Theta2/2),RD^(1+Theta2/2),(2/(Theta2+2))*sqrt(sigma(k)*z/CDE2S)));
           
             % Code for guide function: equation (26) 
            G=(r1^(-(df2-Theta2)/2))*(RD^(1-(df2-Theta2)/2))*((2+Theta2-df2)*posimn(v2,v2,r1^(1+Theta2/2),RD^(1+Theta2/2),(2/(Theta2+2))*sqrt(sigma(k)*z/CDE2S))-sqrt(sigma(k)*z/CDE2S)...
                *(r1^(1+Theta2/2))*posimn(v2+1,v2,r1^(1+Theta2/2),RD^(1+Theta2/2),(2/(Theta2+2))*sqrt(sigma(k)*z/CDE2S)));
           
             % Code for guide function: equation (27) 
            H=((r1*RD)^(-(df2-Theta2)/2))*(((2+Theta2-df2)^2)*posimn(v2,v2,r1^(1+Theta2/2),RD^(1+Theta2/2),(2/(Theta2+2))*sqrt(sigma(k)*z/CDE2S))-sqrt(sigma(k)*z/CDE2S)*(2+Theta2-df2)...
                *(r1^(1+Theta2/2))*posimn(v2+1,v2,r1^(1+Theta2/2),RD^(1+Theta2/2),(2/(Theta2+2))*sqrt(sigma(k)*z/CDE2S))+sqrt(sigma(k)*z/CDE2S)*(2+Theta2-df2)*(RD^(1+Theta2/2))...
                *posimn(v2,v2+1,r1^(1+Theta2/2),RD^(1+Theta2/2),(2/(Theta2+2))*sqrt(sigma(k)*z/CDE2S))-(sigma(k)*z/CDE2S)*((r1*RD)^(1+Theta2/2))*posimn(v2+1,v2+1,r1^(1+Theta2/2),...
                RD^(1+Theta2/2),(2/(Theta2+2))*sqrt(sigma(k)*z/CDE2S)));
            
            % Code for guide function: equation (28) and when m=1 (or equation (60))  
            P=((r1*RD)^(1-(df2-Theta2)/2))*((v2/(2*z))*posimn(v2,v2,r1^(1+Theta2/2),RD^(1+Theta2/2),(2/(Theta2+2))*sqrt(sigma(k)*z/CDE2S))+(1/(2*sqrt(z)))*(2/(Theta2+2))*sqrt(sigma(k)/CDE2S)...
                *(RD^(1+Theta2/2))*posimn(v2,v2+1,r1^(1+Theta2/2),RD^(1+Theta2/2),(2/(Theta2+2))*sqrt(sigma(k)*z/CDE2S)));
           
             % Code for guide function: equation (29) and when m=1 (or equation (61)) 
            Q=(r1^(-(df2-Theta2)/2))*(RD^(1-(df2-Theta2)/2))*((v2/(2*z))*((2+Theta2-df2)*posimn(v2,v2,r1^(1+Theta2/2),RD^(1+Theta2/2),(2/(Theta2+2))*sqrt(sigma(k)*z/CDE2S))-(r1^(1+Theta2/2))...
                *sqrt(sigma(k)*z/CDE2S)*posimn(v2+1,v2,r1^(1+Theta2/2),RD^(1+Theta2/2),(2/(Theta2+2))*sqrt(sigma(k)*z/CDE2S)))+(2/(Theta2+2))*sqrt(sigma(k)/CDE2S)*(RD^(1+Theta2))*(1/(2*sqrt(z)))...
                *((2+Theta2-df2)*posimn(v2,v2+1,r1^(1+Theta2/2),RD^(1+Theta2/2),(2/(Theta2+2))*sqrt(sigma(k)*z/CDE2S))-(r1^(1+Theta2))*sqrt(sigma(k)*z/CDE2S)*posimn(v2+1,v2+1,r1^(1+Theta2/2),...
                RD^(1+Theta2/2),(2/(Theta2+2))*sqrt(sigma(k)*z/CDE2S))));
...
% Three point method for derivative calculation (pressure derivative in thesense of well testing analysis),when  sigma=[0.1,1.1,2.1,3.1]
for k=1:4
...
% Double logarithmic curves of bottomhole pressure at different sigma
...
% Double logarithmic curves of bottomhole pressure derivatives at different sigma
...
h=legend('$$\sigma=0.1$$','$$\sigma=1.1$$','$$\sigma=2.1$$','$$\sigma=3.1$$');
